$(function() {
    ...
    if ($(window).width() > 768) {
        $(
            '.city-dropdown, .filter__content, .filter-top__inner, .favorite__inner, .cart__inner, .search__result'
        ).niceScroll({
            cursorcolor: '#baab82',
        ...
        function init() {
            ...
            myPlacemark1 = new ymaps.Placemark([52.02289564, 47.82915305], {
                balloonContentHeader:
                    '<span class="map-pin__title"> Тц, ГринХаус, Салон Sunangel</span>',
                balloonContentBody:
                    '<span class="map-shop__place">ул. Трнавская, 24</span><span class="map-shop__time"><i class="fa fa-clock-o"></i>10:00 — 22:00</span><span class="map-shop__phone"><i class="fa fa-phone-square"></i><a href="tel:">+7 (999) 000-00-00</a></span>',
                hintContent: 'Sunangel'
            });

            myPlacemark2 = new ymaps.Placemark([52.01096799, 47.79694039], {
                balloonContentHeader:
                    '<span class="map-pin__title"> Тц, Оранж, Салон Sunangel</span>',
                balloonContentBody:
                    '<span class="map-shop__place">ул. Волжская, 100</span><span class="map-shop__time"><i class="fa fa-clock-o"></i>9:00 — 21:00</span><span class="map-shop__phone"><i class="fa fa-phone-square"></i><a href="tel:">+7 (999) 000-00-00</a></span>',
                hintContent: 'Sunangel'
            });
